...
gauge high for fifteen minutes, and the desk has still refused to trade on
every one of those cycles. The counter over an hour sees exactly that, and is
also the sharper statement, because `control` is assigned in priority order:
