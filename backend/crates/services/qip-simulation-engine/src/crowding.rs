//! Does the edge survive company? (ADR 0059, blueprint §15.3)
//!
//! # Why this exists
//!
...
//! arithmetic over numbers somebody chose. ADR 0059 names what would have to
//! change first.
...
/// header and ADR 0059. They are constants rather than parameters because a
...
impl CrowdingOutcome {
    ...
    ///
    /// Reported, never acted on — ADR 0059. A sign inversion is the most
