...
//!
//! ADR 0060 names two things that would void the decision this file implements.
...
fn an_entry_with_no_reviewed_route_is_refused_at_load_and_never_at_the_socket() -> Result<()> {
    // ADR 0060's named failure. The refusal has to happen here, loudly, naming
