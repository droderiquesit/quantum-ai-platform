...
Four, because each one means somebody should look now. An alerting policy that
fires on something nobody acts on trains people to ignore the ones that matter.

| Alert | Threshold | Runbook |
|---|---|---|
| Kill switch tripped | any trip, no duration | [kill-switch](../../docs/operations/kill-switch.md) |
| Live fill in a non-production environment | any fill | should be impossible; two controls have failed |
| Risk limit breached for 15 minutes | 900s | [limit-breach](../../docs/operations/limit-breach.md) |
| Agent attempted an ungranted capability | any, over 5 minutes | [permission-violation](../../docs/operations/permission-violation.md) |
