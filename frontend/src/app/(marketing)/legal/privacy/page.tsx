  ...
  return (
    <LegalShell title="Privacy Policy">
      <LegalSection heading="1. Scope">
        <p>
          This policy will describe how Algorik handles personal data across the public site and
          the signed-in platform. It is written to say what actually happens, in the order a
          reader would ask: what is collected, why, where it goes, and how long it is kept.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="2. What we collect">
        ...
        />
        <p>
          We do not collect payment card data, government identifiers, or brokerage account
          credentials — the Service is paper trading and has no use for them.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="3. What we use it for">
        ...
        />
        <p>
          We do not sell personal data, and the public site sets no third-party advertising or
          tracking cookies.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="4. Cookies and local storage">
        <Bullets
          items={[
            "A session cookie and a request-forgery-protection cookie, both scoped to this origin, are used for signed-in access.",
            "A theme preference may be stored in your browser's local storage. It never leaves your browser.",
          ]}
        />
      </LegalSection>
      ...
      <LegalSection heading="5. Retention">
        <p>
          Working data is kept under explicit bounds, and audit records are retained for as long
          as the record they attest to is retained — a tamper-evident log that could be selectively
          shortened would not be one. Account data is deleted or anonymised on verified request,
          except where a record must be preserved for security or legal reasons; where that
          applies, we will say so in the response.
        </p>
      </LegalSection>

      <LegalSection heading="6. Sharing">
        <p>
          Personal data is shared only with infrastructure providers processing it on our behalf
          under contract, and where the law requires disclosure. A future change to this list
          takes effect only through a published revision of this policy.
        </p>
      </LegalSection>
      ...
      <LegalSection heading="7. Your rights">
        <p>
          ...
          or delete personal data. Requests can be made via the{" "}
          <Link className="underline underline-offset-2" href="/company#contact">
            contact page
          </Link>{" "}
          and will be answered within the period your jurisdiction requires.
        </p>
      </LegalSection>

      <LegalSection heading="8. Changes">
        <p>
          Material changes will be published with a new effective date before they apply. This
          draft has no effective date and is not yet in force.
        </p>
      </LegalSection>
    </LegalShell>
  );
