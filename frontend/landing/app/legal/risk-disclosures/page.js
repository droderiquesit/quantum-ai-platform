...
export const metadata = {
    ...
    description:
        "Simulated results do not predict real trading, no performance is promised, and the platform does not execute live trades.",
}

/**
 * The text is the portal's risk-disclosures document, kept word-for-word so
 * the two public surfaces cannot come to say different things about the same
 * obligation. The landing owns the public copy (see README.md); a divergence
 * here is a defect, not a rewrite.
 */
            ...
            <Layout breadcrumbTitle="Risk disclosures">
                <LegalShell title="Risk Disclosures">
                    <LegalSection heading="1. The three statements that matter most">
                        <Bullets items={[
                            ...
                            <span key="performance">
                                <strong>No performance is promised.</strong> Algorik makes no representation that
                                any strategy, model or output will achieve any result.
                            </span>,
                            <span key="live">
                                <strong>The platform does not execute live trades.</strong>{" "}
                                It submits no orders to any live venue, and the boundary preventing it is enforced
                                in the platform&rsquo;s infrastructure, its start-up checks and its type system.
                            </span>,
                        ]} />
                    </LegalSection>
                    ...
                    <LegalSection heading="2. Limitations of simulated performance">
                        ...
                        <p>A strategy that performs well in simulation may perform poorly, or fail entirely, under
                    ...
                    <LegalSection heading="5. Model and quantum research risk">
                        <p>The platform&rsquo;s reasoning uses machine-learned and language models whose outputs
                            ...
                            experiment is measured against a classical baseline — but a bounded error is still an
