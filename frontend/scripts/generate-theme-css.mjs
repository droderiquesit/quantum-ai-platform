 ...
 * between them.
 *
 * Run (from frontend/): node scripts/generate-theme-css.mjs
...
// Paths resolve from this file, not the caller's cwd — a generator that only
// works from one directory gets run from the wrong one eventually, and a
// `--check` that crashes on a missing file reads as drift that isn't there.
const FRONTEND_ROOT = join(dirname(fileURLToPath(import.meta.url)), "..");

const TARGET = join(FRONTEND_ROOT, "portal/src/app/globals.css");
