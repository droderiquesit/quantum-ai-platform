...
| **M5 First vertical slice working** | One real end-to-end path functions | In progress: waves 1 and 2 merged (19 of 57 slice packets), critical path 2 of 10 (2026-09-26, gate `2b0f33b9`: 6,363 passed, 0 failed) | ADR 0100 §8's eight real-process tests passing in `SLICE-48` |
