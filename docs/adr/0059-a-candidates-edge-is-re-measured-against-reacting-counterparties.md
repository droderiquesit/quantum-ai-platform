# ADR 0059: A candidate's edge is re-measured against reacting counterparties, and may not yet refuse one

- **Status**: Proposed
- **Date**: 2026-09-08
- **Supersedes**: nothing
- **Related**: ADR 0006 (a classical baseline always), ADR 0058 (the market factor)
