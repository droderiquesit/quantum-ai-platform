...
- **Correction of fact, 2026-09-06 (the status and the decision are
  ...
  `total_count: 0`, and the run count is the thing to read rather than whether
  the workflow exists, because GitHub registered the file on 2026-09-06 and
  answered `404` on that endpoint for some hours before it did —
