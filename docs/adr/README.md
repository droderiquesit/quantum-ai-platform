...
| [0011](0011-everything-in-rust-on-kubernetes.md) | Everything is Rust on Kubernetes; IBM Quantum is the only integration — *Kubernetes half superseded in direction by 0022* |
...
| [0017](0017-gitops-delivery.md) | Delivery becomes GitOps: a Helm chart, Argo CD sync, Kargo promotion — *superseded in direction by 0022; still governs what runs* |
