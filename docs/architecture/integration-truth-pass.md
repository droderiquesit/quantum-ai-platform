...
halts the cell; the one test-only helper in `e2e_live.rs` that still read
positions from `orders` followed at `095144b`. The second is a deployed node —
