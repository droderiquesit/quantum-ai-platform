...
- **Done:** 28 (ALIGN-A1, A2, A3, A4, A5, A7 · PHASE-B1, B5, B6, B10, B11,
  B12, B15, B18, B19, B20, B21, B22, B23, New1, New2, New3 · DEC-D1, D4, D6,
  D7, D8, D12, D13 · REG-3)
- **In progress:** 3 (PHASE-B2, B14, B17)
- **Blocked-external:** 11 (ALIGN-A6 · PHASE-B3, B4, B7, B9, B13, B24 · DEC-D2,
  D3, D9, D11)
...
Total rows in this register: 49 (28 done + 3 in progress + 11 blocked-external
+ 6 open + 1 moot).
...
first, 142 commits. Date and time and the first line are read from
