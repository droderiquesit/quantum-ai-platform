...
Summed: **50 of 57 named capabilities at the TESTED bar** (4 + 6 + 4 + 6 +
4 + 15 + 11 over 5 + 7 + 6 + 7 + 5 + 15 + 12 — both sums verified by
addition), **re-derived 2026-09-06 against `PROJECT-PLAN.md` §1, which was
itself corrected at `4ac6027`.**
...
this table now reads 51 of 57. **The totals now agree and the memberships do
...
nothing and mean nothing. §1's composite of 54/71 stitches 51 of these 57 to two layers from
