...
* [Registering a venue](registering-a-venue.md) — what a person does before a source that needs an account is admitted, why the platform offers no anonymous signup, and what the signup job types under a named operator's approval instead (ADR 0041)
