...
on `CellIngestion`. An installed desk reports one such refusal per intent per
...
gate), `a_desk_installed_before_a_withdrawal_stops_trading_the_withdrawn_venue_on_its_next_pass`
