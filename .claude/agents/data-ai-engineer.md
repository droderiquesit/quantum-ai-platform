...
`backend/crates/services/qip-market-ingestion/**`, `qip-data-finder/**`, `qip-world-model/**`, `qip-opportunity-engine/**`, `qip-cost-router/**`, `qip-training/**`, `backend/crates/libs/qip-quantum/**`
